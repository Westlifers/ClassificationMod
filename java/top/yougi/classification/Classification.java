package top.yougi.classification;
...
@Mod(Classification.MODID)
public class Classification
{
    public static final String MODID = "classification";
    ...
    public Classification()
    {
        ...
        ClassificationModMenus.REGISTRY.register(modEventBus);
    }
